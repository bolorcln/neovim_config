...
vim.opt.cmdheight = 2						                    -- more space in the neovim command line for diplaying messages
...
vim.opt.smartindent = true					                -- make indengint smarter again
...
vim.opt.scrolloff = 8                               -- is one of my fave
